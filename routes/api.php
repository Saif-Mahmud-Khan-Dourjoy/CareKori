...
Route::middleware(['auth:sanctum', 'check.token.expiration'])->group(function () {
    ...
    Route::middleware('provider')->group(function () {
        ...
        Route::post('/provider/appointments/{appointment}/conduct-status', [AppointmentController::class, 'updateConductStatus']);
...
Route::get('/all-roles-service-doctor-customer', [UnAuthenticatedController::class, 'getAllRolesOfServiceProviderAndCustomer']);
